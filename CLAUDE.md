...
| Plano 4 — Inteligência Artificial | **A INICIAR** | OCR das fotos e análise de filtros através da API Gemini/Claude. Integração no FilterCheckResource: foto subida → chamada API → preenche resultado_ia e descricao_ia automaticamente. |
