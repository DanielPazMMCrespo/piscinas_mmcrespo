    ...
    private function attachQuickActions(array $viewData): array
    {
        $viewData['piscinas'] = $viewData['piscinas']->map(function (array $item) {
            ...
            $item['acoes_rapidas'] = collect([
                ...
                [DailyRecordResource::getUrl('create', ['pool' => $piscinaId, 'quick' => 1]), 'Registar Água', 'heroicon-m-beaker', ! $encerrada, $podeRegistar],
                [OperationalActionResource::getUrl('create', ['pool' => $piscinaId, 'tipo' => OperationalAction::TIPO_LAVAGEM_FILTRO]), 'Lavar filtro', 'heroicon-m-funnel', false, $podeAcaoOperacional],
                [OperationalActionResource::getUrl('create', ['pool' => $piscinaId, 'tipo' => OperationalAction::TIPO_TORNEIRA]), 'Torneira', 'heroicon-m-adjustments-horizontal', false, $podeAcaoOperacional],
                [OperationalActionResource::getUrl('create', ['pool' => $piscinaId, 'tipo' => OperationalAction::TIPO_CONTADOR]), 'Contador', 'heroicon-m-calculator', false, $podeAcaoOperacional],
