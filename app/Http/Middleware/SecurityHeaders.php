...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp = implode('; ', [
            ...
            "img-src 'self' data: blob: https://*.r2.dev http://piscinasmmcrespo.up.railway.app https://piscinasmmcrespo.up.railway.app http://piscinas-mmcrespo-main.up.railway.app https://piscinas-mmcrespo-main.up.railway.app",
