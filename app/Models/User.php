...
class User extends Authenticatable implements FilamentUser, HasAvatar
{
    ...
    {
        // Janela de silêncio: corta push e e-mail durante a noite/domingos,
        // incluindo conformidade legal. A notificação continua a ser escrita na base de dados
        // e aparece no sino do painel.
        // 'timer_finished' fica de fora: o temporizador foi iniciado pelo próprio utilizador.
        if (in_array($canal, ['push', 'mail'], true) && $key !== 'timer_finished' && app(JanelaSilencio::class)->ativa()) {
            return false;
        }
