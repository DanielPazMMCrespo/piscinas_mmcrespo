 ...
 * nem resumos, nem avisos operacionais de rotina.
 *
 * Padrão: das 22:00 às 08:00 todos os dias, e ao domingo o dia inteiro.
 *
 * O sino in-app continua a gravar silenciosamente na base de dados para que
 * nada se perca no histórico para quando o utilizador entrar na app.
 *
 * Exceções ao silêncio:
 * - Temporizadores manuais explicitamente iniciados pelo utilizador (ex: retrolavagem de filtro)
 * - Notificações de teste disparadas em Definições
 */
class JanelaSilencio
{
    ...
    /**
     * Descrição legível da janela, para helperText e mensagens de interface.
     */
