...
- Não sobrepõe `canAccess()`/policies — depende do comportamento default do pacote; vale a pena confirmar quem consegue mesmo aceder a este log (potencialmente sensível).
