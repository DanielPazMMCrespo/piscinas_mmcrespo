...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduções pt_PT das mensagens de validação por defeito do Laravel.
    | O Laravel não publica um lang/en/validation.php por defeito, por isso
    | sem este ficheiro os erros de validação caem para inglês mesmo com
    | APP_LOCALE=pt_PT. As chaves espelham exatamente as do ficheiro
    | vendor/laravel/framework/.../lang/en/validation.php desta versão.
    |
    */
    ...
    'uploaded' => 'Não foi possível carregar o ficheiro do campo :attribute.',
